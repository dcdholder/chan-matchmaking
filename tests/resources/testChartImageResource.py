...
from qtrest.resources.chartImageResource import ChartImageResource

def testRandomAlphabeticalFilename(): #just a really cursory check
    randomString = ChartImageResource.randomAlphabeticalFilename()

    assert randomString.length==ChartImageResource.filenameNumLetters  #Is the string the right length?
